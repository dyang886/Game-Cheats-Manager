...
void uncheck_all_checkbuttons(Fl_Group *group)
{
  ...
  for (int i = 0; i < group->children(); ++i)
  {
    ...
    // Attempt to cast the child to Fl_Check_Button
...
void apply_callback(Fl_Widget *widget, void *data)
{
  ...
  {
    trainer->setHealth(std::stof(inputValue));
  }
}
...
void toggle_callback(Fl_Widget *widget, void *data)
{
  ...
  if (optionName == "Coin")
  {
    if (button->value())
    {
      trainer->setCoin(std::stoi(inputValue));
    }
    else
    {
      trainer->disableNamedPointerToggle(optionName);
    }
  }
  else if (optionName == "ArrowDamage")
  {
    if (button->value())
    {
      trainer->setArrowDamage(std::stof(inputValue));
    }
    else
    {
      trainer->disableNamedHook(optionName);
    }
  }
  else if (optionName == "ArrowFrequency")
  {
    if (button->value())
    {
      trainer->setArrowFrequency(std::stof(inputValue) / 10.0);
    }
    else
    {
      trainer->disableNamedHook(optionName);
  ...
  else if (optionName == "ArrowSpeed")
  {
    if (button->value())
    {
      trainer->setArrowSpeed(std::stof(inputValue));
    }
    else
    {
      trainer->disableNamedHook(optionName);
  ...
  else if (optionName == "ArrowDistance")
  {
    if (button->value())
    {
      trainer->setArrowDistance(std::stof(inputValue));
    }
    else
    {
      trainer->disableNamedHook(optionName);
  ...
  else if (optionName == "ArrowCount")
  {
    if (button->value())
    {
      trainer->setArrowCount(std::stoi(inputValue));
    }
    else
    {
      trainer->disableNamedHook(optionName);
...
int main(int argc, char **argv)
{
  ...
  Fl_JPEG_Image *game_img = new Fl_JPEG_Image("logo.jpg");
  ...
  Fl_Box *coin_label = new Fl_Box(0, 0, 0, 0, "Coin");
  ...
  set_input_values(coin_input, "9999", "0", "99999999999999999999999999999");
  ...
  // Label for Health
  Fl_Box *health_label = new Fl_Box(0, 0, 0, 0, "Health");
  ...
  // -------------------------
  // Option 3: Set arrow_damage (Toggle)
  // -------------------------
  ...
  Fl_Box *arrow_damage_label = new Fl_Box(0, 0, 0, 0, "Arrow Damage");
  ...
  // // -------------------------
  // // Option 4: Set arrow_frequency (Toggle)
  // // -------------------------
  ...
  Fl_Box *arrow_frequency_label = new Fl_Box(0, 0, 0, 0, "Arrow Frequency");
  ...
  // // -------------------------
  // // Option 5: Set arrow_speed (Toggle)
  // // -------------------------
  ...
  Fl_Box *arrow_speed_label = new Fl_Box(0, 0, 0, 0, "Arrow Speed");
  ...
  // // -------------------------
  // // Option 6: Set arrow_distance (Toggle)
  // // -------------------------
  ...
  Fl_Box *arrow_distance_label = new Fl_Box(0, 0, 0, 0, "Arrow Distance");
  ...
  // // -------------------------
  // // Option 7: Set arrow_count (Toggle)
  // // -------------------------
  ...
  Fl_Box *arrow_count_label = new Fl_Box(0, 0, 0, 0, "Arrow Count");
